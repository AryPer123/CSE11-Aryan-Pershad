# CSE 11 Spring 2026 PA8 - MyStringBuilder
**Due date: Thursday, June 4th @ 11:59PM PST**
...
#### **`public String toString()`**
Since the MSB class is just a way to manipulate and store Strings, we should have a `toString()` method which returns an actual `String` object representing our stored String. This function takes this sequence of CharNodes and turns the sequence of chars into a `String`. **You are allowed to use String’s charAt(), substring(), and length() instance methods.**
...
## Submission
Submit the following file(s) to Gradescope by **Thursday, June 4th @ 11:59PM PST**.
 - MyStringBuilder.java
